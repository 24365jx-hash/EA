...
- 직전 LL 라인 형성 이후 셋업캔들 전까지 어떤 캔들도 그 LL 아래로 종가 돌파마감하면 해당 라인은 무효다.
...
- 직전 HH 라인 형성 이후 셋업캔들 전까지 어떤 캔들도 그 HH 위로 종가 돌파마감하면 해당 라인은 무효다.
...
5. 직전 LL 형성 이후 셋업캔들 전까지 LL 아래 종가 돌파마감이 없어야 한다.
6. 셋업캔들의 저가는 직전 스윙저점을 `MinFalseBreakoutPoints` 이상 실제로 하향 이탈해야 한다.
7. 하향 스윕 폭은 `MaxLevelSweepPoints`를 초과하면 안 된다.
8. 셋업캔들의 종가는 직전 스윙저점 위에서 마감해야 한다.
9. 셋업캔들은 긴 아래꼬리 핀바형이어야 한다.
10. 셋업캔들이 양봉이면 다음 새 봉 오픈 시점에 즉시 BUY 진입한다.
11. 셋업캔들이 양봉이 아니면 셋업캔들을 포함해 3개 캔들 안에서 양봉이 마감될 때 다음 새 봉 오픈 시점에 BUY 진입한다.
...
5. 직전 HH 형성 이후 셋업캔들 전까지 HH 위 종가 돌파마감이 없어야 한다.
6. 셋업캔들의 고가는 직전 스윙고점을 `MinFalseBreakoutPoints` 이상 실제로 상향 이탈해야 한다.
7. 상향 스윕 폭은 `MaxLevelSweepPoints`를 초과하면 안 된다.
8. 셋업캔들의 종가는 직전 스윙고점 아래에서 마감해야 한다.
9. 셋업캔들은 긴 위꼬리 핀바형이어야 한다.
10. 셋업캔들이 음봉이면 다음 새 봉 오픈 시점에 즉시 SELL 진입한다.
11. 셋업캔들이 음봉이 아니면 셋업캔들을 포함해 3개 캔들 안에서 음봉이 마감될 때 다음 새 봉 오픈 시점에 SELL 진입한다.
12. 현재 심볼과 매직넘버 기준 기존 포지션이 없어야 한다.
...
| 기준선 무효화 BUY | 직전 LL 이후 셋업 전 LL 아래 종가 돌파마감이 있으면 탈락 |
| 기준선 무효화 SELL | 직전 HH 이후 셋업 전 HH 위 종가 돌파마감이 있으면 탈락 |
